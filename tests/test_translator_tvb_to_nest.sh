...
parameter='{"param_TR_tvb_to_nest" : {"init": "./test_tvb_to_nest/init_rates.npy", "resolution": 0.1, "synch": '${DELAY}',"percentage_shared": 0.5, "seed": 42, "nb_synapses":10,"level_log": 0,"function_select":2}}'
