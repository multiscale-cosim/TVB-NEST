...
$RUN -n 1 python3 ../nest_elephant_tvb/translation/test_file/spike_nest_input/input_region_activity.py  ../test_nest/7.txt &
...
$RUN -n 1 python3 ./test_nest_filenest-io/spikegenerator_mpi.py
