...
# Test the transformer TVB to Nest
...
mkdir ./test_tvb_to_nest/transformation
mkdir ./test_tvb_to_nest/transformation/spike_generator
mkdir ./test_tvb_to_nest/transformation/receive_from_tvb
...
$RUN -n $1 python3 ../nest_elephant_tvb/transformation/tvb_to_nest.py ./test_tvb_to_nest/ 0&
$RUN -n 1 python3 ./test_transformation/test_input_tvb_to_nest.py  ./test_tvb_to_nest/transformation/receive_from_tvb/0.txt $DELAY &
$RUN -n 1 python3 ./test_transformation/test_receive_tvb_to_nest.py  ./test_tvb_to_nest/ transformation/spike_generator/0.txt 10 &
