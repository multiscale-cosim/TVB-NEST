...
$RUN -n 1 python3 ../nest_elephant_tvb/translation/nest_to_tvb.py ../test_nest/test_nest_to_tvb/ input/0.txt output/0.txt&
sleep 10 # wait for creation of file
$RUN -n 1 python3 ../nest_elephant_tvb/translation/test_file/test_input_nest_to_tvb.py  ../test_nest/test_nest_to_tvb/input/0.txt $DELAY &
$RUN -n 1 python3 ../nest_elephant_tvb/translation/test_file/test_receive_nest_to_tvb.py  ../test_nest/test_nest_to_tvb/output/0.txt &
