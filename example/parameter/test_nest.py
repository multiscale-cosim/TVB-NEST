...
param_TR_nest_to_tvb = {
    ...
    'save_rate_count': 10,   # number of run before saving
    'save_hist': True,       # save the histogram from Nest
...
param_TR_tvb_to_nest = {
    ...
    'save_rate': True,       # save the rate input of TVB
    'save_rate_count': 10,   # number of run before saving
    'save_spike': True,      # save the spikes generated
    'save_spike_count': 10,  # number of run before save the spike trains
}
