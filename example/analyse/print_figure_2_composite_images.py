...
if __name__ == "__main__":
    ...
    plt.savefig('./figure/fig_2_cross_section.png', dpi=300)
    ...
    plt.axis('off')
    plt.subplots_adjust(top=1.0, bottom=0., left=0.0, right=1.0, hspace=0.0, wspace=0.0)
    # plt.savefig('./figure/fig_2_electrode.png', dpi=300)
    ...
    plot_electrode_neurons(ax, X=['ex', 'in'], markers=['^', 'o'], colors=['r', 'b'],
                           ...
                           fraction=0.1)
    plt.subplots_adjust(top=1.0, bottom=0., left=0.0, right=1.0, hspace=0.0, wspace=0.0)
    plt.savefig('./figure/fig_2_electrode_neurons.png', dpi=300)
    ...
    print_mouse('../parameter/data_mouse/', 'mouse_brain.stl', 'centres.txt',
                ...
                save_path='./figure/fig_2_mouse_elect.png',
                figsize=(1200,1200)
                )
    ...
    plt.subplots_adjust(top=1.0, bottom=0., left=0.0, right=1.0, hspace=0.0, wspace=0.0)
    plt.savefig('./figure/fig_2_graph.pdf', dpi=300)
    ...
    plt.savefig('./figure/fig_2_connectome.pdf', dpi=300)