...
rm -rd $DIR/case_up_down/log $DIR/case_up_down/nest $DIR/case_up_down/translation $DIR/case_up_down/tvb $DIR/case_up_down/log.txt $DIR/case_up_down/log_err.txt
...
#rm -rd $DIR/case_regular_burst/log $DIR/case_regular_burst/nest $DIR/case_regular_burst/translation $DIR/case_regular_burst/tvb $DIR/case_regular_burst/log.txt $DIR/case_regular_burst/log_err.txt

sbatch -N 1 -p run -t 10:0:0 --mail-user=lionel.kusch@univ-amu.fr --mail-type=ALL --job-name=up_down --output=$DIR/case_up_down/log.txt --error=$DIR/case_up_down/log_err.txt ./run_job.sh $DIR/../../ $DIR/case_up_down/parameter.json
