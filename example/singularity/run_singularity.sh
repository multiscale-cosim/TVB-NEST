...
rm -rd ./case_asynchronous/log ./case_asynchronous/nest ./case_asynchronous/translation ./case_asynchronous/tvb
rm -rd ./case_regular_burst/log ./case_regular_burst/nest ./case_regular_burst/translation ./case_regular_burst/tvb
