...
proxy_id_2_res=[0] #warning the placeof result is defferent than id except for 1
...
time,result_2,s_2 = sim_2(resolution_monitor,[time,result_1[:,proxy_id_2_res][:,:,0]],s=True)
...
for i in range(0,100):
    ...
    time,result_2,s_2 = sim_2(time_synchronize,[time,result_1[:,proxy_id_2_res][:,:,0]],s=True)
