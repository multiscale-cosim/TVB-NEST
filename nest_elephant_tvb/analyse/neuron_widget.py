def neuron_widget (nb_thread=4):
    ...
    ipw.interact(model,
                 N_ex=ipw.IntSlider(value=100, min=5, max=100, step=5, continous_update=False,
                                 description="N_ex = Number of source neurons", style=style,
                                   layout=layout),
                 R_max_ex=ipw.FloatSlider(value=300, min=0, max=500, step=10, continuous_update=False,
                                       description=r"Max_f_ex = Source neuron max firing rate (Hz)", style=style,
                                   layout=layout),
                 f_ex=ipw.FloatSlider(value=10, min=1, max=50, step=1, continuous_update=False,
                 ...
                 E_ex=ipw.FloatSlider(value=0.0, min=-60.0, max=10.0, step=1.0, continuous_update=False,
                                   ...
                                   layout=layout),
                 tau_syn_ex=ipw.FloatSlider(value=2.0, min=0.0, max=10.0, step=0.01, continuous_update=False,
                                   description=r"tau_syn_ex : Rise time of excitatory synaptic conductance in" 
                                           " ms (alpha function)", style=style,
                                   layout=layout),
                 N_in=ipw.IntSlider(value=100, min=5, max=100, step=5, continous_update=False,
                                 description="N_in = Number of source neurons", style=style,
                                   layout=layout),
                 R_max_in=ipw.FloatSlider(value=300, min=0, max=500, step=10, continuous_update=False,
                                       description=r"Max_f_in Source neuron max firing rate (Hz)", style=style,
                                   layout=layout),
                 f_in=ipw.FloatSlider(value=10, min=1, max=50, step=1, continuous_update=False,
                 ...
                 p_in=ipw.FloatSlider(value=1, min=0, max=1, step=0.01, continuous_update=False,
                                   ...
                                   layout=layout),
                 w_in=ipw.FloatSlider(value=-0.3, min=-1, max=0, step=0.01, continuous_update=False,
                                   description=r"w_syn_in = Synapse weight", style=style,
                                   layout=layout),
                 E_in=ipw.FloatSlider(value=-85.0, min=-100.0, max=0.0, step=1.0, continuous_update=False,
                                   description=r"E_in = Excitatory reversal potential in mV", style=style,
                                   layout=layout),
                 tau_syn_in=ipw.FloatSlider(value=0.2, min=0.0, max=10.0, step=0.01, continuous_update=False,
                                   description=r"tau_syn_in : Rise time of excitatory synaptic conductance in"
                                            " ms (alpha function)", style=style,
                                   layout=layout),
                 C_m=ipw.FloatSlider(value=281, min=0, max=500, step=10, continuous_update=False,
                                     description=r"C_m = Capacity of the membrane in pF ", style=style,
                                   layout=layout),
                 t_ref=ipw.FloatSlider(value=0.0, min=0.0, max=10.0, step=1.0, continuous_update=False,
                         description=r"t_ref : Duration of refractory period in ms", style=style,
                                   layout=layout),
                 g_L=ipw.FloatSlider(value=30, min=0.0, max=100, step=10, continuous_update=False,
                                       description=r"g_L = Leak conductance in nS", style=style,
                                   layout=layout),
                 v_rest=ipw.FloatSlider(value=-70.0, min=-80.0, max=10.0, step=10, continuous_update=False,
                           description=r"E_l = reversal potential (mV)", style=style,
                                   layout=layout),
                 v_reset=ipw.FloatSlider(value=-70.0, min=-80.0, max=10.0, step=1, continuous_update=False,
                           description=r"Vr = voltage reset (mV)", style=style,
                                   layout=layout),
                 v_rheobase=ipw.FloatSlider(value=-70.0, min=-70.0, max=10.0, step=1, continuous_update=False,
                           description=r"Vt = threshold initialisation voltage (mV)", style=style,
                                   layout=layout),
                 a=ipw.FloatSlider(value=0.5, min=-5.0, max=5.0, step=0.1, continuous_update=False,
                           description=r"a = subthreshold adpatative (nS)", style=style,
                                   layout=layout),
                 b=ipw.FloatSlider(value=7.0, min=0.0, max=60.0, step=1.0, continuous_update=False,
                           description=r"b = spikke-triggered adaption(pA)", style=style,
                                   layout=layout),
                 v_spike=ipw.FloatSlider(value=-30., min=-40.0, max=30.0, step=1.0, continuous_update=False,
                 ...
                 delta_T=ipw.FloatSlider(value=2.0, min=0.0, max=10.0, step=1.0, continuous_update=False,
                           description=r"delta_T = slope factor(mV)", style=style,
                                   layout=layout),
                 tau_w=ipw.FloatSlider(value=100.0, min=-200.0, max=200.0, step=10.0, continuous_update=False,
