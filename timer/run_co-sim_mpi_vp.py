...
def run_exploration(path,trail,begin,end,nb_vp):
    ...
    run_exploration_2D(path+'/'+str(nb_vp)+'/'+str(trail)+'/', parameter, {'g':np.arange(1.0, 1.2, 0.5), 'mean_I_ext': [0.0]}, begin, end)
