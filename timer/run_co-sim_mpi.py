...
def run_exploration(path,begin,end,nb_mpi):
    ...
    parameter_test.param_nest['total_num_virtual_procs']=nb_mpi
    ...
    run_exploration_2D(path+'/'+str(nb_mpi)+'/', parameter_test, {'g':np.arange(1.0, 1.2, 0.5), 'mean_I_ext': [0.0]}, begin, end)
